...
<p>
大家好！我叫肖志砺，目前是重庆邮电大学2023级在读通信研究生，本项目是我当前正在进行的一项学术研究的核心实现，通过图神经网络（GNN）建模复杂网络结构，并高效识别其中的重要节点，具有较高的理论价值和应用潜力。
...
<table>
  <tr>
    <td valign="top" width="50%">
      ...
      <p>
      我们于 <strong>2025年7月</strong> 完成全部实验，并正式提交论文。
      </p>
      <p>
    ...
    <td valign="top" width="50%">
      ...
      <p>
      若您对该项目感兴趣，欢迎通过邮件与我联系。无论您希望进行代码审阅、技术交流，还是借鉴实现方法，我都将非常乐意在确认用途后，提供项目代码的限时访问权限。
      </p>
      <p>
